...
`emojikit/build_collection.py` = the repo's own `assets/god-verify-emoji-logo.png`, so a
...
**Brand logo preview.** `--bot-username GodVerifyEmojiMapperbot` selects branding
